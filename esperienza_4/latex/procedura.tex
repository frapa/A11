...
\bigskip
I dati ricavati sono riportati in Tabella (\ref{tab:dati}), mentre i valori della pressione atmosferica ($P_a$) delle due giornate di esperienza sono riportati in tabella (\ref{tab:ptu}).
