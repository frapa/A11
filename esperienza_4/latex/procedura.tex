...
\begin{SCtable}
    ...
    Sono riportati in ordine di rilevamento. L'incertezza standard di risoluzione sul dislivello è di \SI{0.3}{mm},
    mentre l'incertezza tipo di risolizione sulla temperatura
    è \SI{0.003}{\celsius}. I valori numerici riportati nella tabella non hanno la stessa precisione delle incertezze poiché non avrebbe
    senso superare la risoluzione ed il valore di lettura dello strumento.
    La serie 1 si riferisce alla prima giornata di laboratorio, mentre la serie 2 indica i dati raccolti nel secondo pomeriggio.}
    \label{tab:dati}
\end{SCtable}
