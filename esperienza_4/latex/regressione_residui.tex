...
\begin{SCtable}[][t]
    ...
    \begin{tabular}{c c @{\hspace{0.8cm}} c c @{\hspace{0.8cm}} c c @{\hspace{0.8cm}} c c}
        ...
        \bottomrule
    \end{tabular}
    \caption{I dati sono stati divisi in quattro gruppi distinti in base agli andamenti residui. La tabella riporta i 
    dati divisi tra i quattro gruppi. I gruppi 1 e 2 sono ricavati dalla prima serie di dati, metre gli altri due dalla
