...
\begin{SCtable}[][t]
    \centering
    \small
    \begin{tabular}{c c @{\hspace{0.7cm}} c c @{\hspace{0.7cm}} c c @{\hspace{0.7cm}} c c}
    ...
    di tale temperatura. Per approfondimenti su cifre significative ed errori vedere la Tabella \ref{tab:dati}, da cui questa è
    stata estratta.}
    \label{tab:gruppi}
\end{SCtable}
...
% qui non ho messo figure maiuscolo perché è plurale e non è il nome di una figura
