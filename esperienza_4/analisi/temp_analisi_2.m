...
chi_1_meno = chi2(H1_meno, T1_meno, sigma_H1_tot, A_1, B_1)
chi_1r2_meno = chi2(H1r2_meno, T1r2_meno, sigma_H1r2_tot, A_1r2, B_1r2)

display(" ");
sigma_H1_tot_corr = sqrt(sum((H1 - A_1 - B_1*T1).^2) / 20)
sigma_H1_tot_corr / sigma_H1_tot
sigma_H1_tot_corr_meno = sqrt(sum((H1_meno - A_1 - B_1*T1_meno).^2) / 19)
sigma_H1_tot_corr_meno / sigma_H1_tot
...
sigma_H1r2_tot_corr_meno = sqrt(sum((H1r2_meno - A_1r2 - B_1r2*T1r2_meno).^2) / 13)
sigma_H1r2_tot_corr_meno / sigma_H1r2_tot
