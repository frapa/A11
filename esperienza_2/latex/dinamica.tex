...
\end{equation*}
%
purtroppo il nostro valore del chi quadro osservato è:

\begin{equation*}
	\chi_{oss}^2 \,\,=\,\, 21.1 \quad \text{che non risulta essere compatibile con il} \quad \chi_{teo}^2
\end{equation*}
%
...
\end{equation*}
%
e quindi non risulta che $|R| \, \leq \, k \, \sigma_{R}$.\\

Dal momento che il chi quadro osservato risulta essere molto maggiore del chi quadro teorico crediamo che questo sia dovuto al fatto che abbiamo sottostimato le incertezze sulle misure 
