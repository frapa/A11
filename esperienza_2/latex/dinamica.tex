...
\end{equation*}
%
quindi posto a priori un fattore di copertura $k \,=\, 3$ calcoliamo lo scarto relativo al resto R ($\sigma R$):

\begin{equation*}
	\sigma R \,\,=\,\, \sqrt{(\delta k_{dinamico})^2 \,-\, (\delta k_{statico})^2} \,\,=\,\, 0.03 N/m	
\end{equation*}
%
...
\end{equation*}
%
e infatti risulta che $|R| \,\leq\, k\,\sigma R$ e pertanto le due costanti elastiche trovate con le due procedure sono compatibili.
