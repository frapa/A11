...
\begin{itemize}
	\item{balla definizione di B sappiamo che:
	
			\begin{equation*}
				B \,\,=\,\, \frac{\mathcal{C}^2}{k} \quad => \quad k \,\,=\,\, \frac{\mathcal{C}^2}{B} \,\,=\,\,
			\end{equation*}}
...
\begin{itemize}
	\item{per stimare l'errore relativo alla costante elastica si può procedere come segue:
			...
			\begin{equation*}
				\delta k_0 \,\,=\,\, \frac{\delta B}{\mathcal{C}^2} \,\,=\,\,
			\end{equation*}
			%
			}
	\item{mentre per stimare l'errore sulla massa efficace della molla si può fare:
