...
\begin{itemize}
	\item{La funzione da minimizzare che misura della discrepanza è:
			\begin{equation}
...
\item{Calcoliamo il chi quadro (oss sta per osservato, ovvero calcolato dai dati sperimentali):
	...
	\begin{equation*}
		\chi_{oss}^2 \,=\, \sum_{i=1}^{N} \frac{(x_i - b_0 F_{p_i})^2}{(\delta x_i^2)} = 28.9
	\end{equation*}
	%
...
\begin{equation*}
	\frac{(x_i - b_0 F_{p_i})^2}{(\delta x_i)^2} \, \gg \, 1
\end{equation*}
%
