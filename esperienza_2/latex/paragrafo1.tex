...
\end{equation*}
%
abbiamo deciso di non usare l'incertezza tipo sull'errore di misurazione in quanto, come detto sopra, le misure potevano non risultare così fedeli poichè soggette anche a variazioni repentine dell'ambiente esterno.
...
\end{equation*}
%
Per quanto riguarda gli errori di misura dell'allungamento della molla rispetto alla sua posizione di equilibrio le considerazioni sono quelle esposte nel paragrafo precedente. Bisnogna però aggiungere che la posizione iniziale della molla è stata calcolata con il piattello portapesi già agganciato ad essa.\\
...
Il secondo metodo che addottiamo per il calcolo della costante elastica della molla elicoidale è quello di considerare la distribuzine dei valori $K_i$, ovvero se ne deve calcolare la media campionaria $m^*_k$ e stimarne l'errore casuale. In questo modo otteniamo:

\begin{equation*}
	k_0 \,\,=\,\, m^*_k \,\,=\,\, \frac{1}{13}\,\,\sum_{i=1}^{13} (k_i) \,\,=\,\,  \,\,N/m
\end{equation*}
%
\begin{equation*}
	\sigma_{k_0} \,=\, \sqrt{\frac{1}{13}\,\,\sum_{i=1}^{13} (k_i - m^*_k)^2} \,\,=\,\,  \,\,N/m
\end{equation*}
%
poichè sappiamo che 
ottenendo la misura
