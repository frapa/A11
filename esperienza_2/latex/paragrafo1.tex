...
\begin{itemize}
	\item{primo allungamento $x_{all_1}$ = $(11.70 \pm 0.04) \,\,cm$}
	\item{secondo allungamento $x_{all_2}$ = $(11.60 \pm 0.04) \,\,cm$}
	\item{terzo allungamento $x_{all_3}$ = $(11.60 \pm 0.04) \,\,cm$}
	\item{quarto allungamento $x_{all_4}$ = $(11.60 \pm 0.04) \,\,cm$}
	\item{quinto allungamento $x_{all_5}$ = $(11.60 \pm 0.04) \,\,cm$}
\end{itemize}
...
Fatta questa precisazione possiamo osservare che gli allungamenti relativi al ciclo di carico e scarico (ultimi quattro valori) sono uguali tra di loro e pqrtanto sono anche compatibili gli uni con gli altri.\\
Analizziamo quini se questi allungamenti sono compatibili con la prima misura effettuata della deformazione della molla: posto a priori un fattore di copertura pari a 3 (K = 3) andiamo a calcolare il resto tra il primo allungamento $x_{all_1}$ e uno degli altri quattro risulti minore di $k \, \sigma_R$, dove $\sigma_R$ rappresenta l'errore relativo ad R.\\
