...
f2.suptitle("Dipendenza del periodo dalla lunghezza", y=0.93, fontsize=15)
...
ax2.set_xlabel(u'Lunghezza del filo [m]', labelpad=12, fontsize=14)
ax2.set_ylabel(u'Periodo [s]', labelpad=12, fontsize=14)
...
ax2.set_xticks([log10(l/100.0) for l in range(15, 125, 10)])

ax2.set_xticklabels(['0.15', '0.25', '0.35', '0.45', '0.55', '0.65', '0.75', '0.85', '0.95', '1.05', '1.15'], rotation=45)

ax2.set_yticks([log10(l/100.0) for l in range(75, 250, 25)])
ax2.set_yticklabels([str(l/100.0) for l in range(75, 250, 25)])
#ax.set_ylim((2.04, 2.07))
ax2.grid(True)

#ax2.text(-0.03, -0.1, "0")

ax2.legend((dots, fit2), ("Periodi con incertezza", "Dipendenza lineare"), 'upper left',
        prop={'size': 12}, numpoints=1)

f2.subplots_adjust(left=0.13, right=0.93, top=0.88, bottom=0.16)
